...
from batchpy.__version__ import version as __version__
...
latex_documents = [
    (master_doc, 'batchpy.tex', u'batchpy Documentation',
...
man_pages = [
    (master_doc, 'batchpy', u'batchpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'batchpy', u'batchpy Documentation',
     author, 'batchpy', 'A package to run batches of similar computations and store the result',
     'Miscellaneous'),
]
